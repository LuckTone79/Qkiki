...
| Starter | $29/mo | 1,800 | 300 | 개인 사용자, 라이트 업무 |
| Pro | $99/mo | 6,000 | 1,000 | 반복 검토, 고성능 모델 사용자 |
| Team | $299/mo | 20,000 | 3,500 | 소규모 팀, 장문 검토 |
| Credit Pack | $89 | 10,000 | 플랜 일한도 적용 | 피크 사용, 프로젝트성 사용 |

연간 결제:

| 플랜 | 연간 가격 | 할인율 | 판단 |
|---|---:|---:|---|
| Starter Annual | $290/year | 약 2개월 할인 | 초기 전환용 |
| Pro Annual | $990/year | 약 2개월 할인 | 주력 |
| Team Annual | $2,990/year | 약 2개월 할인 | B2B 협상 가능 |
...
- 기본 표시: `$29/mo`, `$99/mo`, `$299/mo`
- 보조 표시: "Includes 1,800 credits/month"
- 한국어 UI: "월 $29", "월 1,800 크레딧 포함"
...
- 승인 빠른 쪽으로 우선 구현.
- USD 플랜 생성: Starter $29, Pro $99, Team $299, Credit Pack $89.
- webhook endpoint 구현.
- 결제 성공 시 앱 플랜/크레딧 반영.
- 환불/취소 처리.
- 영어 가격 페이지와 약관 초안 게시.
