...
export const LEGACY_GOOGLE_OAUTH_STATE_COOKIES = [
  "qkiki_google_oauth_state",
] as const;
export const GOOGLE_OAUTH_STATE_COOKIE_CANDIDATES = [
  GOOGLE_OAUTH_STATE_COOKIE,
  ...LEGACY_GOOGLE_OAUTH_STATE_COOKIES,
] as const;
